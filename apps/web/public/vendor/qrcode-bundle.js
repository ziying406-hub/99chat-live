...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	var t = u(), n = _(), r = d(), i = C(), a = x(), o = 7973, s = t.getBCHDigit(o);
	function c(t, n, r) {
	...
	function p(t, n) {
		for (let r = 1; r <= 40; r++) if (f(t, r) <= e.getCapacity(r, n, i.MIXED)) return r;
	}
	e.from = function(e, t) {
	...
	var t = u(), n = 1335, r = 21522, i = t.getBCHDigit(n);
	...
	var n = C(), r = /* @__PURE__ */ "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".split("");
	function i(e) {
	...
	var t = C(), n = E(), r = D(), i = O(), a = k(), o = S(), s = u(), c = A();
	function l(e) {
	...
	function f(e) {
		let n = d(o.NUMERIC, t.NUMERIC, e), r = d(o.ALPHANUMERIC, t.ALPHANUMERIC, e), i, a;
		return s.isKanjiModeEnabled() ? (i = d(o.BYTE, t.BYTE, e), a = d(o.KANJI, t.KANJI, e)) : (i = d(o.BYTE_KANJI, t.BYTE, e), a = []), n.concat(r, i, a).sort(function(e, t) {
		...
		for (let o = 0; o < e.length; o++) {
			...
			for (let e = 0; e < s.length; e++) {
				...
				for (let e = 0; e < a.length; e++) {
					let o = a[e];
					r[o] && r[o].node.mode === l.mode ? (i[o][u] = p(r[o].lastCount + l.length, l.mode) - p(r[o].lastCount, l.mode), r[o].lastCount += l.length) : (r[o] && (r[o].lastCount = l.length), i[o][u] = p(l.length, l.mode) + 4 + t.getCharCountIndicator(l.mode, n));
				}
			}
			a = c;
		}
	...
	e.fromArray = function(e) {
		return e.reduce(function(e, t) {
			return typeof t == "string" ? e.push(_(t, null)) : t.data && e.push(_(t.data, t.mode)), e;
		}, []);
	}, e.fromString = function(t, n) {
		let r = g(h(f(t, s.isKanjiModeEnabled())), n), i = c.find_path(r.map, "start", "end"), a = [];
	...
	var t = u(), n = d(), r = f(), i = p(), a = m(), o = h(), s = g(), c = _(), l = b(), v = w(), y = T(), x = C(), S = j();
	function E(e, t) {
	...
	function N(e, n, i) {
		...
		i.forEach(function(t) {
			a.put(t.mode.bit, 4), a.put(t.getLength(), x.getCharCountIndicator(t.mode, e)), t.write(a);
		});
	...
	function F(e, n, r, a) {
		let o;
		if (Array.isArray(e)) o = S.fromArray(e);
		else if (typeof e == "string") {
			let t = n;
			if (!t) {
				let n = S.rawSplit(e);
				t = v.getBestVersionForData(n, r);
			}
			o = S.fromString(e, t || 40);
		} else throw Error("Invalid data");
		let c = v.getBestVersionForData(o, r);
		if (!c) throw Error("The amount of data is too big to be stored in a QR Code");
		if (!n) n = c;
		else if (n < c) throw Error("\nThe chosen QR Code version cannot contain this amount of data.\nMinimum version required to store current data is: " + c + ".\n");
		let l = N(n, r, o), u = new i(t.getSymbolSize(n));
		return E(u, n), D(u), O(u, n), A(u, r, 0), n >= 7 && k(u, n), M(u, l), isNaN(a) && (a = s.getBestMask(u, A.bind(null, u, r))), s.applyMask(a, u), A(u, r, a), {
			modules: u,
			version: n,
	...
	e.create = function(e, r) {
		...
		let i = n.M, a, o;
		return r !== void 0 && (i = n.from(r.errorCorrectionLevel, n.M), a = v.from(r.version), o = s.from(r.maskPattern), r.toSJISFunc && t.setToSJISFunction(r.toSJISFunc)), F(e, a, i, o);
	};
})), N = /* @__PURE__ */ o(((e) => {
	function t(e) {
